...
- Parameters:
  - options: [DirectionsRendererOptions](/ipostmap-map/web/v1.0/reference/directions-renderer.md?id=directionsrenderer-options) *required*

**Methods**

| Name                         | Parameters                              | Return Value | Description                                                                            |
|------------------------------|:---------------------------------------:|:------------:|----------------------------------------------------------------------------------------|
| **setOptions**|[DirectionsRendererOptions](/ipostmap-map/web/v1.0/reference/directions-renderer.md?id=directionsrenderer-options)|`none`| Set options dùng để xác định các thuộc tính dùng cho DirectionsRenderer |
| **setMap**                   | [Map](/ipostmap-map/web/v1.0/reference/map.md?id=map-class)      | `none`       | Thêm Directions Renderer vào map, nếu set map là **null** thì Directions Renderer sẽ bị xóa khỏi map |
| **getMap**                   | `none`                                  | Map          | Lấy đối tượng map mà Directions Renderer được thêm vào                                 |
| **setRoutes**                | string `or` [RouteOptions](/ipostmap-map/web/v1.0/reference/directions-renderer.md?id=routeoptions) `or` [ILatLng](/ipostmap-map/web/v1.0/reference/coordinates.md?id=ilatlng)[][]| `none`| Set các routes cho Directions Renderer bằng một mảng 2 chiều các tọa độ ILatLng hoặc dữ liệu Route bằng JSON string trả về từ [Map4D SDK API Route](https://docs.map4d.vn/map4d-service/api/v1.1/#/api_route) hoặc một đối tượng [RouteOptions](/ipostmap-map/web/v1.0/reference/directions-renderer.md?id=routeoptions) |
| **getRoutes**                | `none` |  [LatLng](/ipostmap-map/web/v1.0/reference/coordinates.md?id=latlng)[][]| Get mảng tạo độ các routes của Directions Renderer                                    |
...
| **setActiveStrokePattern**   | [PatternItem](/ipostmap-map/web/v1.0/reference/map.md?id=patternitem)| `none`   | Set pattern cho active line trong Directions Renderer. Tương tự như [pattern của Polyline](/ipostmap-map/web/v1.0/guides/polyline.md?id=_4-tạo-một-polyline-sử-dụng-pattern)|
| **setInactiveStrokePattern** | [PatternItem](/ipostmap-map/web/v1.0/reference/map.md?id=patternitem)| `none`   | Set pattern cho inactive line trong Directions Renderer. Tương tự như [pattern của Polyline](/ipostmap-map/web/v1.0/guides/polyline.md?id=_4-tạo-một-polyline-sử-dụng-pattern)|
...
| **activeStrokePattern** *optional* |[PatternItem](/ipostmap-map/web/v1.0/reference/map.md?id=patternitem)| chỉ định pattern của active line. Tương tự như [pattern của Polyline](/ipostmap-map/web/v1.0/guides/polyline.md?id=_4-tạo-một-polyline-sử-dụng-pattern)|
